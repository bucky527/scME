...
def rna_protein_preprocess(rnadata:pd.DataFrame,proteindata:pd.DataFrame)->ad.AnnData:
    ...
    sc.tl.leiden(rna, key_added="rna_leiden",resolution=0.5)
    #protein
    ...
    sc.tl.leiden(protein, key_added="protein_leiden",resolution=0.5)
    return rna,protein
